...
import com.halo.ecommerce.Entity.PaymentOrder;
import com.halo.ecommerce.Entity.User;
import com.halo.ecommerce.Repository.OrderRepository;
import com.halo.ecommerce.Repository.PaymentOrderRepository;
import com.halo.ecommerce.Service.PaymentService;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    public String createStripePaymentLink(User user, Long amount, Long orderId) {
                        ...
                        SessionCreateParams.LineItem.builder()
                                ...
                                .setPriceData(
                                        SessionCreateParams.LineItem.PriceData.builder()
                                                .setCurrency("usd")
                                                .setUnitAmount(amount * 100) // Stripe expects smallest currency unit
                                                .setProductData(
                                                        SessionCreateParams.LineItem.PriceData.ProductData.builder()
                                                                .setName("Gaurav_bazaar_payment")
                                                                .build()
                                                )
                                                .build()
                                )
        ...
        try {
            ...
            return session.getUrl(); // Return payment link URL
